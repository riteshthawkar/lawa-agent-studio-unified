...
class SubscriptionModelTest(TestCase):
    ...
    def test_create_subscription_free_tier(self):
        ...
        self.assertEqual(sub.get_effective_plan(), 'free')
    ...
    def test_create_subscription_with_trial(self):
        ...
        self.assertEqual(sub.get_effective_plan(), 'trial')
...
class TierConfigTest(TestCase):
    ...
    def test_get_tier_features_basic(self):
        ...
        self.assertEqual(features['max_days'], 30)
        self.assertEqual(features['top_queries_limit'], 20)
        self.assertIn('json', features['export_formats'])
        self.assertIn('query_categories', features['features'])
    ...
    def test_has_feature_free_tier(self):
        ...
        self.assertTrue(has_feature('free', 'core_stats'))
        self.assertFalse(has_feature('free', 'query_categories'))
    ...
    def test_get_analytics_retention_days(self):
        ...
        self.assertEqual(get_analytics_retention_days('free'), 7)
        self.assertEqual(get_analytics_retention_days('basic'), 30)
    ...
    def test_get_export_formats(self):
        ...
        self.assertEqual(get_export_formats('basic'), ['json'])
    ...
    def test_get_query_limit(self):
        ...
        self.assertEqual(get_query_limit('basic'), 20)
...
class AnalyticsEndpointTierTest(TestCase):
    ...
    def test_analytics_endpoint_basic_tier(self):
        ...
        self.assertEqual(response.data['tier']['max_days'], 30)
        self.assertIn('query_categories', response.data['tier']['features'])
