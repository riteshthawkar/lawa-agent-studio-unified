...
class ChatbotModelTestCase(TestCase):
    ...
    def test_chatbot_creation(self):
        ...
        self.assertIn('apiKey', chatbot.embed_code)
...
class ChatbotAPITestCase(APITestCase):
    ...
    def test_chatbot_list(self):
        ...
        with patch('apps.core.middleware.OrganizationMiddleware') as mock_middleware:
...
class ChatbotIndexInfoTestCase(APITestCase):
    ...
    def test_chatbot_index_info_success(self):
        ...
        self.assertEqual(indexing_info['pinecone_index'], 'lawa-website-index')
        ...
        self.assertEqual(chatbot_config['model'], 'gpt-3.5-turbo')
