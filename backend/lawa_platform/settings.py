...
WIDGET_CDN_PORT = env('WIDGET_CDN_PORT', default='5174')
...
PINECONE_INDEX_NAME = env('PINECONE_INDEX_NAME', default=env('DEFAULT_PINECONE_INDEX', default='lawa-website-index'))
