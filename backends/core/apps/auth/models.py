...
class SupportRequest(BaseModel):
    ...
    subject = models.CharField(max_length=255, help_text="Issue summary")
    description = models.TextField(help_text="Detailed description of the issue")
    
    # Bug Report Details
    steps_to_reproduce = models.TextField(null=True, blank=True, help_text="Steps to reproduce the bug")
    expected_behavior = models.TextField(null=True, blank=True, help_text="What was expected to happen")
    actual_behavior = models.TextField(null=True, blank=True, help_text="What actually happened")
    
    # Metadata
    screen_resolution = models.CharField(max_length=50, null=True, blank=True, help_text="Screen resolution")
